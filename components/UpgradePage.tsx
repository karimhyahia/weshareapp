...
const LIFETIME_PLANS = [
  {
    ...
    features: [
      ...
      { text: '100 QR Scans/Month', included: true },
      { text: 'Profile Customization', included: true },
      { text: '2 Services & 2 Projects', included: true },
      { text: 'Premium Themes', included: false },
      { text: 'Custom Colors & Fonts', included: false },
      { text: 'Remove Branding', included: false },
      { text: 'Contact Forms', included: false },
      { text: 'Video Integration', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Contact Forms & Lead Collection', included: true },
      { text: 'Services (10) & Projects (10)', included: true },
      { text: 'Video & Voice Integration', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Unlimited Sites ✨', included: true, highlight: true },
      { text: 'Unlimited Services & Projects', included: true },
      { text: 'Team Management (5 members)', included: true },
      { text: 'API Access', included: true },
      { text: 'White Label Options', included: true },
      { text: 'Bulk Operations & Management', included: true },
